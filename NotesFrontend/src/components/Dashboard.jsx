        ...
        <div className="notes-list">
          {notes.map((note) => (
            <div key={note.id} className="note-item">
              ...
              <button className="btn btn-sm btn-info ml-2" onClick={() => startEditNote(note)}>Update</button>
              <button className="btn btn-sm btn-danger ml-2" onClick={() => handleDeleteNote(note.id)}>Delete</button>
            </div>
          ))}
        </div>
      </div>
